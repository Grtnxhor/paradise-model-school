...
<html lang="en">
<head>
	<title>Paradise Model School</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="offcanvas-menu-wrapper">
		...
		<ul style="font-size: 20px" class="main-menu">
			...
			<li><a href="dashboard/student/./login">School Portal</a></li>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="contact-info">
							...
							<h4 style="text-align: center; color: darkgrey;">Your details have been saved sucessfully. <br/> Kindly check your email to get your Entrance ID</h4>
							</div>
