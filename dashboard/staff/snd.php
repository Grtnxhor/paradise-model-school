          ...
          <div class="col-md-12">
            ...
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Upload Second Term Report Sheet</h3>
              </div>
              <div class="card-body">
                <!-- Date dd/mm/yyyy -->
...
<br/><br/>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" placeholder="Input Other Name" value="SECOND TERM" class="form-control" name="term" disabled>
                  </div>
                  <!-- /.input group -->
                </div>
                <!-- /.form group -->
