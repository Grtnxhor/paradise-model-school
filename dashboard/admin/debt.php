  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Debtors<sup><span class="badge badge-info right">Total Aount: NGN <?php echo $_SESSION['ts']; ?></span></sup>  <button style="background: grey; color: white;" type="button" class="btn btn-tool" onclick="window.print();"><i class="fas fa-print"></i>
                  Print</button></h1> 
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">View Debtors</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
         <?php
 $sql="SELECT * FROM students WHERE class='Nusery'";
 $result_set=query($sql);
 while($row= mysqli_fetch_array($result_set))
 {
  ?>                
                    <tr>
                      <td><?php echo $row['Admincode']."".$row['Admission No.'] ?></td>
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
         <?php
 $sql="SELECT * FROM students WHERE class='JSS 1'";
 $result_set=query($sql);
 while($row= mysqli_fetch_array($result_set))
 {
  ?>                
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
         <?php
 $sql="SELECT * FROM students WHERE class='JSS 2'";
 $result_set=query($sql);
 while($row= mysqli_fetch_array($result_set))
 {
  ?>                
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
         <?php
 $sql="SELECT * FROM students WHERE class='JSS 3'";
 $result_set=query($sql);
 while($row= mysqli_fetch_array($result_set))
 {
  ?>                
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
         <?php
 $sql="SELECT * FROM students WHERE class='SSS 1'";
 $result_set=query($sql);
 while($row= mysqli_fetch_array($result_set))
 {
  ?>                
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
         <?php
 $sql="SELECT * FROM students WHERE class='SSS 2'";
 $result_set=query($sql);
 while($row= mysqli_fetch_array($result_set))
 {
  ?>                
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
         <?php
 $sql="SELECT * FROM students WHERE class='SSS 3'";
 $result_set=query($sql);
 while($row= mysqli_fetch_array($result_set))
 {
  ?>                
