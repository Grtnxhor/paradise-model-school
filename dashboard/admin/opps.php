...
<head>
  ...
  <title>Paradise Model School | Dashboard</title>
...
<div class="lockscreen-wrapper">
  <div class="lockscreen-logo">
    <a href="https://paradisemodelschool.com.ng"><b>😥 Opps!</b></a>
  </div>
  <!-- User name -->
  <div class="lockscreen-name"></div>
  
  <div class="help-block text-center">
   Access to this resource is denied <br/><br/>
   <button type="button" class="text-center btn btn-primary" onclick="goBack();">Go back</button>
  </div>
