    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Staff has been registered succesfully and now has an account on the school portal<br/>
 ...
 <a href="./empl" target="_blank">
              <div class="info-box-content">
                ...
                <span class="progress-description">
                 Please save all document offline for future refrences
                </span>
              </div>
            </a>
              <!-- /.info-box-content -->
