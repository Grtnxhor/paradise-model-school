...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
      <img src="dist/img/favicon2.ico" alt="Paradise Model School" class="brand-image img-circle elevation-3"
           style="opacity: .8">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./ent" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View all applicant</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./exam" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Applicant Exam Date</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./result" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Applicant Results</p>
                </a>
              </li>
