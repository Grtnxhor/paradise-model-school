    ...
    <section class="content">
      ...
      <div style="background: red; color: white;" class="card">
        <div class="card-header">
          <h3 class="card-title">Staff Deleted Successfully</h3>
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" placeholder="Input Staff ID" name="adm" class="form-control" required>
                  </div>
                  <!-- /.input group -->
                </div>
                <!-- /.form group -->
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>You are about to delete a staff from the school database! <br/> Are you sure you want to continue?</p>
            </div>
