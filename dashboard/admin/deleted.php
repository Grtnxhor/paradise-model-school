...
<section class="content">
      ...
      <div style="background: red; color: white;" class="card">
        <div class="card-header">
          <h3 class="card-title">Student Deleted Successfully</h3>
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" placeholder="Input Student Admission No." name="name" class="form-control" required>
                  </div>
                  <!-- /.input group -->
                </div>
                <!-- /.form group -->
