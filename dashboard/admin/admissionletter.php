...
$pdf->SetFont('Arial','',10);
...

 {
        ...
        $pdf->Image('http://localhost/paradise%20school/portal/admin/upload/studentDP/'."".$row['Passport'],145,50,50,50);
...
$sqll = "UPDATE students SET `admletter` = '$file' WHERE `id` = '".$_SESSION["id"]."'";
$re   = query($sqll);
