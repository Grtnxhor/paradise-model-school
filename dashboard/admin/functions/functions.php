...
$sql.= " VALUES('$admcode', '$code', '$d', '1', '$sname', '$fname', '$lname', '$rpwor', '$pwor', '$day', '$mont', '$yea', '$gend', '$schl', '$paren', '$rel', '$occ', '$dnu', '$ad', '$mnu', '$datereg', '$cls', '$dep', '0', '$target_file', '$sh', '$ac', '$e')";
$result = query($sql);
$last_id = insert();
session_start();
$_SESSION["id"] = $last_id;
...
$sql.= "VALUES ('1', '$admcode', '$d', '$code', '$titl', '$sname', '$fname', '$lname', '$day', '$mont', '$yea', '$gend', '$schl', '$cls', '$dep', '$paren', '$rel', '$occ', '$ad', '$add', '$dnu', '$mnu', '$target_file', '0', '$d')";
$result = query($sql);
$staff_id = insert();
session_start();
