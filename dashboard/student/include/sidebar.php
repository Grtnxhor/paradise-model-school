...
?>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <br/>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a target="_blank" href="../staff/upload/downloads/listofbooks.pdf" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List of Books</p>
                </a>
              </li>
              <li class="nav-item">
                <a target="_blank" href="../staff/upload/downloads/newsletter.pdf" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Newsletter</p>
                </a>
              </li>
   ...
   $pass = str_replace('/', '', $data);
 {
  ?>             
            ...
            ?>
               <li class="nav-item">
                <a target="_blank" href="../staff/upload/downloads/schoolbill.pdf" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>School Bill</p>
                </a>
              </li>
